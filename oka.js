...
const reply = (teks) => {
return okta.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `Aku Sayang ${botname}🥰`,"body": `Selamat ${ucapanWaktu} kak ${pushname}`, mediaType: 1, renderLargerThumbnail: true, "previewType": "PHOTO","thumbnailUrl": 'https://b.top4top.io/p_2966mul881.jpeg',"thumbnail": thumb,"sourceUrl": `https://www.instagram.com/davidlouis1712?utm_source=qr&igsh=YmZ5ZG1pbXFrNWwy`}}}, { quoted:m})} 
